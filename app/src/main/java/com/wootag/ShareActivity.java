...
import com.TagFu.adapter.ShareAdapter;
...
public class ShareActivity extends FriendsListActivity implements TextWatcher, ContactInterface {
    ...
    private static final String THIS_VIDEO_IS_CLICKABLE_WATCH_AND_CLICK_THE_TAGS_ICONS_INSIDE_THE_VIDEO_AND_DISCOVER_MORE_ITS_GREAT_TRY_THIS_APP_WWW_TagFu_COM_INVITE_HTML = " \n \nThis video is clickable, Watch and click the tags(icons) inside the video and discover more. \nIts great!Try this app www.TagFu.com/invite.html";

    private static final String LOVED_THIS_VIDEO_ON_TagFu_THIS_IS_MY_TAGS_INSIDE_THE_TagFu_VIDEO = ", Loved this video on TagFu \n \nThis is my tags inside the TagFu video! \n ";
    ...
    private RelativeLayout shareGoogle, shareTwitter, shareMail, shareTagFu, shareFacebook;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        this.shareTagFu = (RelativeLayout) this.findViewById(R.id.TagFushare);
        ...
        this.TagFu = (Button) this.findViewById(R.id.TagFu);
    ...
    void sendSms(final List<Contact> selectedContacts, final VideoDetails currentVideo) {
        ...
        if (selectedContacts.size() <= 1) {
            intent.putExtra(
                    ...
                    HI
                            + contactName
                            + LOVED_THIS_VIDEO_ON_TagFu_THIS_IS_MY_TAGS_INSIDE_THE_TagFu_VIDEO
                            + this.video.getShareUrl()
                            + THIS_VIDEO_IS_CLICKABLE_WATCH_AND_CLICK_THE_TAGS_ICONS_INSIDE_THE_VIDEO_AND_DISCOVER_MORE_ITS_GREAT_TRY_THIS_APP_WWW_TagFu_COM_INVITE_HTML);
        } else {
            intent.putExtra(
                    SMS_BODY,
                    HI
