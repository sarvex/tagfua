...
import com.TagFu.pushnotifications.GCMRegistration;
import com.TagFu.pushnotifications.PushNotificationReceiver;
...
public class VideoPlayerApp extends Application {
    ...
    public List<Friend> getTagFuFriendsList() {
    ...
    public void setTagFuFriendsList(final List<Friend> wtFriendsList) {
