 ...
 * {@link com.TagFu.facebook.model.GraphObject.Factory Factory} class). A GraphObjectList can actually contain elements
...
public interface GraphObjectList<T> extends List<T> {
     ...
     * @throws com.TagFu.facebook.FacebookGraphObjectException if T does not derive from GraphObject
     */
