...
public class SuggestedUserFragment extends BaseFragment {
        ...
        this.searchEdit.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            private void performSearch() {
                ...
                if ((text != null) && (text.trim().length() > 0)) {
                    SuggestedUserFragment.this.TagFuSearchFriendsList.clear();
        ...
        this.search.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (SuggestedUserFragment.this.searchLayout.isShown()) {
                    ...
                    SuggestedUserFragment.this.loadData(SuggestedUserFragment.this.TagFuFriendsList);
                } else {
    ...
    void getMore() {
        ...
        if (!this.searchRequest) {
            final int offset = this.TagFuFriendsList.size();
            ...
            final int offset = this.TagFuSearchFriendsList.size();
            final int pageNo = (offset / SuggestedUserFragment.VIDEOS_PER_PAGE) + 1;
            if ((offset % SuggestedUserFragment.VIDEOS_PER_PAGE) == 0) {
                this.flagLoading = true;
                new FriendFinderAsync(Config.getUserId(), pageNo, true, this.searchRequest).execute();
    ...
    private class FriendFinderAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            if (this.isSearch) {
                ...
                try {
                    this.response = Backend.getTagFuFriendFinderList(SuggestedUserFragment.this.context, this.userId,
                            this.pageNo);
                } catch (final JSONException exception) {
                    LOG.e(exception);
                }
                ...
                if (this.response instanceof List<?>) {
                    ...
                    if (!this.isSearch) {
                        if (SuggestedUserFragment.this.pullToRefresh) {
                            ...
                            SuggestedUserFragment.this.TagFuFriendsList.clear();
                        }

                        if (list != null) {
                            SuggestedUserFragment.this.TagFuFriendsList.addAll(list);
                        }
                        SuggestedUserFragment.this.loadData(SuggestedUserFragment.this.TagFuFriendsList);
                    } else {
                        if (SuggestedUserFragment.this.pullToRefresh) {
                        ...
                        if (list != null) {
                            SuggestedUserFragment.this.TagFuSearchFriendsList.addAll(list);
                        }
                        SuggestedUserFragment.this.loadData(SuggestedUserFragment.this.TagFuSearchFriendsList);
                    }
