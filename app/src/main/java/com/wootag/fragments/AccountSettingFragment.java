...
import com.TagFu.ChangePasswordActivity;
import com.TagFu.Constant;
import com.TagFu.R;
import com.TagFu.adapter.CropOptionAdapter;
...
public class AccountSettingFragment extends FriendsListFragment {
    ...
    private void createImageFile() {
        ...
        final File effortFolder = new File(Environment.getExternalStorageDirectory() + TagFu);
