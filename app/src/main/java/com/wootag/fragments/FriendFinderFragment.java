...
public class FriendFinderFragment extends FriendsListFragment implements TextWatcher, InviteInterface, ContactInterface {
    ...
    private void loadViews() {
        ...
        this.search.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (FriendFinderFragment.this.searchLayout.isShown()) {
                    ...
                    FriendFinderFragment.this.loadData(FriendFinderFragment.this.TagFuFriendsList);
                } else {
        ...
        this.searchEdit.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            private void performSearch() {
                ...
                if ((FriendFinderFragment.this.TagFuSearchFriendsList != null)
                        && (FriendFinderFragment.this.TagFuSearchFriendsList.size() > 0)) {
                    FriendFinderFragment.this.TagFuSearchFriendsList.clear();
                }
                ...
                if ((lastItem == totalItemCount) && (FriendFinderFragment.this.preLast != lastItem)) { // to avoid
                    ...
                    if (!FriendFinderFragment.this.flagLoading) {
                        if (FriendFinderFragment.this.searchRequest) {
                            final int offset = FriendFinderFragment.this.TagFuSearchFriendsList.size();
                            ...
                            final int offset = FriendFinderFragment.this.TagFuFriendsList.size();
                            if ((offset % FriendFinderFragment.VIDEOS_PER_PAGE) == 0) {
                                FriendFinderFragment.this.flagLoading = true;
                                final int pageNo = (offset / FriendFinderFragment.VIDEOS_PER_PAGE) + 1;
                                new FriendFinderAsync(Config.getUserId(), pageNo, true,
    ...
    private class FriendFinderAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            if (this.isSearch) {
                ...
                try {
                    this.response = Backend.getTagFuFriendFinderList(FriendFinderFragment.this.context, this.userId,
                            this.pageNo);
                } catch (final JSONException exception) {
                    LOG.e(exception);
                }
                ...
                if (this.response instanceof List<?>) {
                    ...
                    if (!this.isSearch) {
                        if (FriendFinderFragment.this.pullToRefresh) {
                            ...
                            FriendFinderFragment.this.TagFuFriendsList.clear();
                        }

                        if (list != null) {
                            FriendFinderFragment.this.TagFuFriendsList.addAll(list);
                        }
                        FriendFinderFragment.this.loadData(FriendFinderFragment.this.TagFuFriendsList);
                    } else {
                        if (FriendFinderFragment.this.pullToRefresh) {
                        ...
                        if (list != null) {
                            FriendFinderFragment.this.TagFuSearchFriendsList.addAll(list);
                        }
                        FriendFinderFragment.this.loadData(FriendFinderFragment.this.TagFuSearchFriendsList);
                    }
    ...
    private class SocialFriendFinderAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            try {
                this.response = Backend.getTagFuSocialFriendsList(FriendFinderFragment.this.context, this.request);
            } catch (final JSONException exception) {
                LOG.e(exception);
            }
            return null;
