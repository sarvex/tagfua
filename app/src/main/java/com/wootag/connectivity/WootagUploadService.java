...
public class TagFuUploadService extends WakefulIntentService {
    ...
    private final Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(final Message msg) {
            ...
            final AlertDialog.Builder dialog = new AlertDialog.Builder(TagFuUploadService.this.getApplicationContext());
            final Playback inf = (Playback) msg.obj;
            dialog.setMessage(inf.getVideoTitle() + " Uploaded successfully.");
            final TextView hollaMessage = new TextView(TagFuUploadService.this.getApplicationContext());
            ...
            dialog.setPositiveButton(R.string.tag, new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int index) {
                    ...
                    if (inf.getVideoId() != null) {
                        final Intent intent = new Intent(TagFuUploadService.this.getApplicationContext(),
                        ...
                        TagFuUploadService.this.getApplicationContext().startActivity(intent);
            ...
            dialog.setNeutralButton(R.string.share, new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int which) {
                    ...
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra(VIDEO, video);
                    TagFuUploadService.this.startActivity(intent);
    ...
    public TagFuUploadService() {

        super(TagFuUploadService.class.getSimpleName());
    }
    ...
    private void postVideoUrlOnSocialSite(final Playback videoInf, final String clientVideoId) {
        ...
        if (Util.isAppForground(this.getApplicationContext())) {
            ...
            final Intent shareIntent = new Intent(TagFuUploadService.this, ShareActivity.class);
    ...
    private class partsUploadTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            TagFuUploadService.this.time = TagFuUploadService.this.time + 1;
            // System.out.println("timer val :"+time);
            if (TagFuUploadService.this.time >= 120) {
                if ((TagFuUploadService.this.video != null)
                        && (TagFuUploadService.this.video.getVideoClientId() != null)) {
                    VideoDataBase.getInstance(TagFuUploadService.this.getApplicationContext()).updatePartsUpload(
                            TagFuUploadService.this.video.getVideoClientId(), 1);

                    final Intent intent = new Intent(Constant.HIDE_PROGRESS);
                    TagFuUploadService.this.sendBroadcast(intent);
                    TagFuUploadService.this
                ...
                TagFuUploadService.this.timer.cancel();
                TagFuUploadService.this.timer = null;
            }
        }
    }
    ...
    private class uploadTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            if (TagFuUploadService.this.time >= 60) {
                if ((TagFuUploadService.this.video != null)
                        && (TagFuUploadService.this.video.getVideoClientId() != null)) {
                    VideoDataBase.getInstance(TagFuUploadService.this.getApplicationContext()).updateUploadVideoState(
                            TagFuUploadService.this.video.getVideoClientId(), 1);
                ...
                TagFuUploadService.this.uploadTimer.cancel();
                TagFuUploadService.this.uploadTimer = null;
            }
        }
    }
