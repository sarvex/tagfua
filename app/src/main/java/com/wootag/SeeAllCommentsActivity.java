...
import com.TagFu.adapter.ImageAdapter;
...
public class SeeAllCommentsActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        this.usersListView = (ListView) this.findViewById(R.id.TagFufriendslist);
        ...
        this.writecomment.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(final Editable s) {
                ...
                if (s != null) {
                    ...
                    if (name.indexOf('@') != -1) {
                        if ((VideoPlayerApp.getInstance().getTagFuFriendsList() != null)
                                && (VideoPlayerApp.getInstance().getTagFuFriendsList().size() > 0)) {
                            ...
                            SeeAllCommentsActivity.this.setFilterList(VideoPlayerApp.getInstance()
                                    .getTagFuFriendsList(), actualStirng);
                        } else {
