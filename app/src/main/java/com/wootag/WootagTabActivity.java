...
import com.TagFu.video.trimmer.view.VideoActivity;
import com.TagFu.video.trimmer.view.ViewVideo;

public class TagFuTabActivity extends Activity {
    ...
    public static TagFuTabActivity TagFuTabActivity;
    ...
    private View view;
    private TagFuTabActivity context;
    private int index;
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (action != null) {
                if (Constant.NOTIFICATION.equalsIgnoreCase(action)) {
                    TagFuTabActivity.this.notificationIcon.setVisibility(View.VISIBLE);

                } else if (Constant.FEED_NOTIFICATION.equalsIgnoreCase(action)) {
                    TagFuTabActivity.this.homeNotificationsIcon.setVisibility(View.VISIBLE);

                } else if (Constant.NOTIFICATION_VISITED.equalsIgnoreCase(action)) {
                    TagFuTabActivity.this.notificationIcon.setVisibility(View.GONE);

                } else if (Constant.FEED_NOTIFICATION_VISITED.equalsIgnoreCase(action)) {
                    TagFuTabActivity.this.homeNotificationsIcon.setVisibility(View.GONE);

                } else if (Constant.VIDEO_UPLOADED.equalsIgnoreCase(action)) {
                    new MyPageAsyncReq(TagFuTabActivity.this).execute();
                }
            }
        }
    };
    ...
    TabHost.OnTabChangeListener listener = new TabHost.OnTabChangeListener() {
        ...
        public void onTabChanged(final String tabId) {
            ...
            TagFuTabActivity.this.currentTab = tabId;
            final FragmentManager fragmentManager = TagFuTabActivity.this.getFragmentManager();
            ...
            if (Constant.BROWSE.equalsIgnoreCase(tabId)) {
                ...
                if (browseFragment == null) {
                    ...
                    TagFuTabActivity.this.tabStack.get(tabId).push(browse);
                    fragmentTransaction.add(R.id.browsTab, browse, Constant.BROWSE);
                    fragmentTransaction.commitAllowingStateLoss();
                }
                TagFuTabActivity.this.browseTab.setVisibility(View.VISIBLE);
                TagFuTabActivity.this.notificationTab.setVisibility(View.GONE);
                TagFuTabActivity.this.myPageTab.setVisibility(View.GONE);
                TagFuTabActivity.this.feedTab.setVisibility(View.GONE);
                ...
                if (notificationsFragment == null) {
                    ...
                    TagFuTabActivity.this.tabStack.get(tabId).push(notiifcation);
                    fragmentTransaction.add(R.id.notificationTab, notiifcation, Constant.NOTIFICATIONS);
                    fragmentTransaction.commitAllowingStateLoss();
                }
                TagFuTabActivity.this.browseTab.setVisibility(View.GONE);
                TagFuTabActivity.this.notificationTab.setVisibility(View.VISIBLE);
                TagFuTabActivity.this.myPageTab.setVisibility(View.GONE);
                TagFuTabActivity.this.feedTab.setVisibility(View.GONE);
                if (TagFuTabActivity.this.notificationIcon != null) {
                    TagFuTabActivity.this.notificationIcon.setVisibility(View.GONE);
                }
                ...
                if (mypageFragment == null) {
                    ...
                    TagFuTabActivity.this.tabStack.get(tabId).push(myPage);
                    fragmentTransaction.add(R.id.mypageTab, myPage, Constant.MYPAGE);
                    fragmentTransaction.commitAllowingStateLoss();
                }
                TagFuTabActivity.this.browseTab.setVisibility(View.GONE);
                TagFuTabActivity.this.notificationTab.setVisibility(View.GONE);
                TagFuTabActivity.this.myPageTab.setVisibility(View.VISIBLE);
                TagFuTabActivity.this.feedTab.setVisibility(View.GONE);
                ...
                if (videoFeedFragment == null) {
                    ...
                    TagFuTabActivity.this.tabStack.get(tabId).push(feed);
                ...
                TagFuTabActivity.this.notificationTab.setVisibility(View.GONE);
                TagFuTabActivity.this.myPageTab.setVisibility(View.GONE);
                TagFuTabActivity.this.feedTab.setVisibility(View.VISIBLE);
                if (TagFuTabActivity.this.homeNotificationsIcon != null) {
                    TagFuTabActivity.this.homeNotificationsIcon.setVisibility(View.GONE);
                }
            } else if (tabId.equalsIgnoreCase(Constant.RECORD)) {
                try {
                    TagFuTabActivity.this.setCurrentTab(Config.getCurrentTabIndex());
                    final Intent recordIntent = new Intent(TagFuTabActivity.this, VideoActivity.class);
                    TagFuTabActivity.this.startActivity(recordIntent);
    ...
    public void initializeTabs() {
        ...
        spec.setContent(new TabHost.TabContentFactory() {
            ...
            public View createTabContent(final String tag) {
                ...
                return TagFuTabActivity.this.findViewById(R.id.feedTab);
            }
        });
        ...
        spec.setContent(new TabHost.TabContentFactory() {
            ...
            public View createTabContent(final String tag) {
                ...
                return TagFuTabActivity.this.findViewById(R.id.browsTab);
            }
        });
        ...
        spec.setContent(new TabHost.TabContentFactory() {
            ...
            public View createTabContent(final String tag) {
                ...
                return TagFuTabActivity.this.findViewById(R.id.recordTab);
            }
        });
        ...
        spec.setContent(new TabHost.TabContentFactory() {
            ...
            public View createTabContent(final String tag) {
                ...
                return TagFuTabActivity.this.findViewById(R.id.notificationTab);
            }
        });
        ...
        spec.setContent(new TabHost.TabContentFactory() {
            ...
            public View createTabContent(final String tag) {
                ...
                return TagFuTabActivity.this.findViewById(R.id.mypageTab);
            }
        });
    ...
    private void showOptionDialogs() {
        ...
        chooseFromLibrary.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                TagFuTabActivity.this.startActivityForResult(Intent.createChooser(intent, "Pick video from"),
                        TagFuTabActivity.ACTIVITY_CHOOSE_FILE);
            }
        });
        ...
        record.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                try {
                    alertDialog.dismiss();
                    final Intent recordIntent = new Intent(TagFuTabActivity.this, AndroidVideoCapture.class);
                    TagFuTabActivity.this.startActivity(recordIntent);
                } catch (final ActivityNotFoundException e) {
                    LOG.e(e);
                }
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        if ((requestCode == TagFuTabActivity.ACTIVITY_CHOOSE_FILE) && (resultCode == RESULT_OK)) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (mimeType.contains(MP4) || mimeType.contains(_3GP)) {
                    // System.gc();
                    final Intent intent = new Intent(TagFuTabActivity.this, ViewVideo.class);
                    intent.putExtra(VIDEO_FILE_NAME, videoPath);
                    this.startActivity(intent);
                } else {
                    Toast.makeText(TagFuTabActivity.this, VIDEO_FORMAT_WAS_NOT_SUPPORTED, Toast.LENGTH_LONG).show();
                }
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_TagFu_tab);
        TagFuTabActivity = this;
        this.context = this;
    ...
    public class MyPageAsyncReq extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(final Void result) {
            ...
            TagFuTabActivity.this.sendBroadcast(new Intent(Constant.MY_PAGE_REFRESH));
