        ...
        this.searchEdit.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            private void performSearch() {
                ...
                if ((text != null) && (text.trim().length() > 0)) {
                    SuggestedUserActivity.this.TagFuSearchFriendsList.clear();
        ...
        this.searchButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (SuggestedUserActivity.this.searchLayout.isShown()) {
                    ...
                    SuggestedUserActivity.this.loadData(SuggestedUserActivity.this.TagFuFriendsList);
                } else {
    ...
    private class FriendFinderAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            if (this.search) {
                ...
                try {
                    this.response = Backend.getTagFuFriendFinderList(SuggestedUserActivity.this.context, this.userId,
                            this.pageNo);
                ...
                if (this.response instanceof List<?>) {
                    ...
                    if (!this.search) {
                        if (SuggestedUserActivity.this.pullToRefresh) {
                            ...
                            SuggestedUserActivity.this.TagFuFriendsList.clear();
                        }

                        if (list != null) {
                            SuggestedUserActivity.this.TagFuFriendsList.addAll(list);
                        }
                        SuggestedUserActivity.this.loadData(SuggestedUserActivity.this.TagFuFriendsList);
                    } else {
                        if (SuggestedUserActivity.this.pullToRefresh) {
                        ...
                        if (list != null) {
                            SuggestedUserActivity.this.TagFuSearchFriendsList.addAll(list);
                        }
                        SuggestedUserActivity.this.loadData(SuggestedUserActivity.this.TagFuSearchFriendsList);
                    }
