...
public class FriendFinderAdapter extends ArrayAdapter<Friend> implements AsyncResponse, FollowInterface {
    ...
    private static final String HTTP_TagFu_COM_INVITE_JPG = "http://TagFu.com/invite.jpg";
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (!NULL.equalsIgnoreCase(friendsObj.getTagFuId())) {
        ...
        follow.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                final String userId = FriendFinderAdapter.this.currentFollower.getTagFuId();
                if (userId != null) {
    ...
    public void publishFeedDialog(final String fbId) {
        ...
        params.putString(LINK, WWW_TagFu_COM_INVITE_HTML);
        params.putString(PICTURE, HTTP_TagFu_COM_INVITE_JPG);
