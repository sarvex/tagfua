...
public final class FacebookRequestError {
    ...
    public FacebookRequestError(final int errorCode, final String errorType, final String errorMessage) {

        this(INVALID_HTTP_STATUS_CODE, errorCode, INVALID_ERROR_CODE, errorType, errorMessage, null, null, null, null,
                null);
    }

    private FacebookRequestError(final int requestStatusCode, final int errorCode, final int subErrorCode,
            final String errorType, final String errorMessage, final JSONObject requestResultBody,
            final JSONObject requestResult, final Object batchRequestResult, final HttpURLConnection connection) {
    ...
    private FacebookRequestError(final int requestStatusCode, final int errorCode, final int subErrorCode,
            final String errorType, final String errorMessage, final JSONObject requestResultBody,
            final JSONObject requestResult, final Object batchRequestResult, final HttpURLConnection connection,
            final FacebookException exception) {
    ...
    FacebookRequestError(final HttpURLConnection connection, final Exception exception) {
    ...
    static FacebookRequestError checkResponseAndCreateError(final JSONObject singleResult, final Object batchResult,
            final HttpURLConnection connection) {

        try {
            if (singleResult.has(CODE_KEY)) {
                final int responseCode = singleResult.getInt(CODE_KEY);
                final Object body = Utility.getStringPropertyAsJSON(singleResult, BODY_KEY,
                ...
                if ((body != null) && (body instanceof JSONObject)) {
                    ...
                    if (jsonBody.has(ERROR_KEY)) {
                        ...
                        final JSONObject error = (JSONObject) Utility
                                .getStringPropertyAsJSON(jsonBody, ERROR_KEY, null);
    ...
    public String toString() {
        ...
        return new StringBuilder("{HttpStatus: ").append(this.requestStatusCode).append(", errorCode: ")
                .append(this.errorCode).append(", errorType: ").append(this.errorType).append(", errorMessage: ")
                .append(this.getErrorMessage()).append("}").toString();
    }
