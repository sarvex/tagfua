...
public enum AccessTokenSource {
    ...
    NONE(false),
    /**
     * Indicates an access token was obtained by the user logging in through the Facebook app for Android using the web
     * login dialog.
     */
    FACEBOOK_APPLICATION_WEB(true),
    /**
     * Indicates an access token was obtained by the user logging in through the Facebook app for Android using the
     * native login dialog.
     */
    FACEBOOK_APPLICATION_NATIVE(true),
    /**
     * Indicates an access token was obtained by asking the Facebook app for the current token based on permissions the
     * user has already granted to the app. No dialog was shown to the user in this case.
     */
    ...
    AccessTokenSource(final boolean canExtendToken) {
